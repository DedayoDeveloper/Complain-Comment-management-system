...
<!--    <div class="row">
    ...
    <div class="modal-body">
        <a href="${pageContext.request.contextPath}/manageProducts" class="btn btn-primary link">Back</a>
    </div>
<div id="result"></div>
<form action="${pageContext.request.contextPath}/editproduct" method="post" name="updateproduct">
    <div class="modal-body">
        <div class="form-group">
            ...
            <div>
                ...
                <label> Edit Product Description</label>
                      <br>
                      <input class="form-control" type="text" name="productdescription" value="${productdescription}" required>
            </div>

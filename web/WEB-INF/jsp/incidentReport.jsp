...
/* body{
     background-image: url(".../imgs/hand.jpeg");
...
<div class="row">
  ...
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
    ...
    <div>
        <p style="color:  red;">You are signed in as <b style=" color:  whitesmoke;">${username}</b></p>
        <p style=" color: red;">Your institution is <br><b style=" color:  whitesmoke;">${institutionname}</b></p>
     </div>
           <a>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#incidenceModal" id="buttn">Log Case</button>
           </a>
         ...
         <a>
            ...
            <!--</div>-->
             <a href="<c:url value="j_spring_security_logout" />" ><button type="submit" class="btn btn-primary" id="btty">Log Out</button></a>
                ...
                <div class="modal fade" id="incidencereportdownload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content ">
                            ...
                            <form action="${pageContext.request.contextPath}/downloadincidencereport3" method="post" name="reports_form">
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            
                                            <input type="hidden" name="institutionname"  id="institutionname" value="${institutionname}">
...
<!--                                    <div class="modal fade" id="closeIncidenceThreadModal" tabindex="-1" role="dialog" aria-labelledby="closeIncidenceThreadModalModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body mx-auto">
                                                    ...
                                                    <div>
                                                        <form action="${pageContext.request.contextPath}/closeincidence" method="post" name="form_closeIncidence">
                                                            <input type="text" name="id" value="${incidence.id}">
                                                            <input type="hidden" name="username" value="${username}">
                                                            <div id="footerClose">
                      ...
                      <a class="btn btn-sm btn-primary link" href="${pageContext.request.contextPath}/editincidence/${incidence.id}/${incidence.title}">Attach File</a>
                               ...
                               <td> <a  id="fileval" href="${pageContext.request.contextPath}/filedownload/${incidence.id}/${incidence.filename}">${incidence.filename}</a></td>
...
<div class="modal fade" id="incidenceModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style=" background-color:  #222222;">
                <h5 class="modal-title" id="exampleModalLabel" style=" color: red; text-align: center;">Log New Case</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div id="result"></div>
            <form action="logincidence" name="newIncidence" id="newIncidence" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="products">
                            ...
                            <c:forEach items="${getInstitutions}" var = "getInstitutions">
                                <option value="${getInstitutions.products}">${getInstitutions.products}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary"><i class="fa fa-plus"></i> Log</button>
                        ...
                        <div class="modal fade" id="AttachFileModal" tabindex="-1" role="dialog" aria-labelledby="closeIncidenceThreadModalModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header" style=" background-color:  #222222;">
                                        <h5 class="modal-title" id="AttachFileModalModalLabel" style=" color: red;">Attach File To Case</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div id="toggleDiv">
                                            <div class="w-75 mx-auto">
                                                <div class="bg-white mb-2 p-2">
                                                    <h4 class="p5"><b>Attach file here</b></h4>
                                                    <hr>
                                                    <div id="drop_display"></div>
                                                
                                                    <form action="${pageContext.request.contextPath}/uploadfile" method="POST" enctype="multipart/form-data">                            
                                                         
                                                        <input type="hidden" name="userid" value="${incidence.id}">
                                                    ...
                                                    <div class="form-group text-center m-2">
                                                        ...
                                                        <button type="submit" class="btn btn-primary" id="submit_file">Upload Files</button>
    ...
    if (errors.length > 0) {
        ...
        $.post(form.attr('action'), data, function (result) {
            if (result === 'Successful') {
                form.after('<div class="alert alert-success text-center m-3">Case Successfully Logged</div>');
                setTimeout(function () {
                    form[0].reset();
                    form.next().remove();
                    form.show('fast');
...
Dropzone.options.dropzoneFormPayments = {
                autoProcessQueue: false,
                init: function () {
                    var submitButtonn = document.getElementById("submit_file");
                    ...
                    this.on("processing", function(file) {
                        this.options.url = "/SwitchPayPortal/uploadFiles";
                    });
                },
                success: function () {
...
// Get the modal
var modal = document.getElementById('AttachFileModal');

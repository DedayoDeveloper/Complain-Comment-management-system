...
<!--    <div class="row">
    ...
    <div class="modal-body">
        <a href="${pageContext.request.contextPath}/newUser" class="btn btn-primary link">Back</a>
    </div>
<div id="result"></div>
<form action="${pageContext.request.contextPath}/editUser" method="post" name="UserEdit">
    <div class="modal-body">
        <div class="form-group">
            ...
            <div>
                ...
                <input class="form-control" type="text" name="phonenumber" value=${phonenumber}>
                  <br/>
                <label> Edit Login Status </label>
                      
                <input class="form-control" type="text" name="firsttimelogin" value=${firsttimelogin}>
            </div>

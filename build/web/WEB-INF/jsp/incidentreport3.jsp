...
<div class="row">
  ...
  <p style=" color: red;">You are signed in as <b style=" color:  whitesmoke;"> <br>${username} ADMIN</b></p>
                ...
                <div class="modal fade" id="incidencereportdownload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content ">
                            ...
                            <form action="downloadincidencereport" method="post" name="reports_form">
